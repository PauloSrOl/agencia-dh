...
ScrollReveal({ 
 ...
 function selecionarProjeto(tipoProjeto) {
    const botao = document.getElementById('botao-orcamento');
    botao.textContent = `Peça seu orçamento para ${tipoProjeto}`;
    botao.href = `https://wa.me/5591999999999?text=Olá! Gostaria de um orçamento para ${encodeURIComponent(tipoProjeto)}.`;
}
